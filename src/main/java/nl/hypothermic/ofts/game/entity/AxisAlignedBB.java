...
public class AxisAlignedBB {
    ...
    public boolean a(Vec3D vec3d) {
        return vec3d.xCoord > this.a && vec3d.yCoord < this.d ? (vec3d.yCoord > this.b && vec3d.yCoord < this.e ? vec3d.zCoord > this.c && vec3d.zCoord < this.f : false) : false;
    }
    ...
    private boolean b(Vec3D vec3d) {
        return vec3d == null ? false : vec3d.yCoord >= this.b && vec3d.yCoord <= this.e && vec3d.zCoord >= this.c && vec3d.zCoord <= this.f;
    }

    private boolean c(Vec3D vec3d) {
        return vec3d == null ? false : vec3d.xCoord >= this.a && vec3d.xCoord <= this.d && vec3d.zCoord >= this.c && vec3d.zCoord <= this.f;
    }

    private boolean d(Vec3D vec3d) {
        return vec3d == null ? false : vec3d.xCoord >= this.a && vec3d.xCoord <= this.d && vec3d.yCoord >= this.b && vec3d.yCoord <= this.e;
    }
